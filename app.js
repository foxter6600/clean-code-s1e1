...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.classList.add("del-button__img")
...
var editTask=function(){
    ...
    editInput.classList.toggle("li__input-text_active");
    label.classList.toggle("label_disabled");
